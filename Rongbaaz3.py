...
\033[1;92m---------------------BRAND---------------------
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mThe Credit For This Code Goes To Shanto..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91mDEVOLPER
                     SHANTO AHMED 
\033[1;94mFACEBOOK
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.comSHANTOAHMED.com')
    else:
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1]  START CLONING With SHANTO'
    time.sleep(0.10)
    print '\x1b[1;92m[2] SHANTO FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6] SHANTO FACEBOOK'
    time.sleep(0.10)
